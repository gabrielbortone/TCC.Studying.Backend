        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name_FirstName = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: true),
                    Name_LastName = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: true),
                    CPF_Number = table.Column<string>(type: "nvarchar(11)", maxLength: 11, nullable: true),
                    UrlImage = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
                    Scholarity = table.Column<string>(type: "nvarchar(45)", maxLength: 45, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FatherTopicId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Topic", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Topic_Topic_FatherTopicId",
                        column: x => x.FatherTopicId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StudentId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    Title = table.Column<string>(type: "nvarchar(125)", maxLength: 125, nullable: true),
                    UrlDocument = table.Column<string>(type: "nvarchar(400)", maxLength: 400, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Document_Topic_TopicId",
                        column: x => x.TopicId,
                        principalTable: "Topic",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeckOfCardsId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Topic_FatherTopicId",
                table: "Topic",
                column: "FatherTopicId");
