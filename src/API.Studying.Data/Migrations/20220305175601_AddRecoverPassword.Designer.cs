...
namespace API.Studying.Data.Migrations
{
    ...
    [Migration("20220305175601_AddRecoverPassword")]
    partial class AddRecoverPassword
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Studying.Domain.Entities.Commitment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("API.Studying.Domain.Entities.DeckOfCard", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("API.Studying.Domain.Entities.Playlist", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("API.Studying.Domain.Entities.PreferencesUser.Star.StarDeckOfCard", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("API.Studying.Domain.Entities.PreferencesUser.Star.StarExercise", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("StarExercise");
                });

            modelBuilder.Entity("API.Studying.Domain.Entities.PreferencesUser.Star.StarPlaylist", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("API.Studying.Domain.Entities.PreferencesUser.StudentDeckOfCard", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("API.Studying.Domain.Entities.PreferencesUser.StudentPlaylist", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("API.Studying.Domain.Entities.Card", b =>
                {
                    b.HasOne("API.Studying.Domain.Entities.DeckOfCard", "DeckOfCards")
                        .WithMany("Cards")
                        .HasForeignKey("DeckOfCardsId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("API.Studying.Domain.Entities.Card", "Next")
                        .WithOne()
                        .HasForeignKey("API.Studying.Domain.Entities.Card", "NextId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("API.Studying.Domain.Entities.Video", b =>
                {
                    b.HasOne("API.Studying.Domain.Entities.Playlist", "Playlist")
                        .WithMany("Videos")
