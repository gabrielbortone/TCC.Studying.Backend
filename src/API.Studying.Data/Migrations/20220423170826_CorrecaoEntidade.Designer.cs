...
namespace API.Studying.Data.Migrations
{
    ...
    [Migration("20220423170826_CorrecaoEntidade")]
    partial class CorrecaoEntidade
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Studying.Domain.Entities.Reports.CardUserReport", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("CardUserReport");
                });

            modelBuilder.Entity("API.Studying.Domain.Entities.Reports.CardViewReport", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("API.Studying.Domain.Entities.Reports.ExerciseUserReport", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ExerciseUserReport");
                });

            modelBuilder.Entity("API.Studying.Domain.Entities.Reports.ExerciseViewReport", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ExerciseViewReport");
                });

            modelBuilder.Entity("API.Studying.Domain.Entities.Reports.PostViewReport", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("API.Studying.Domain.Entities.Reports.CardViewReport", b =>
                {
                    b.HasOne("API.Studying.Domain.Entities.Card", "Card")
                        .WithMany()
            ...
            modelBuilder.Entity("API.Studying.Domain.Entities.Reports.DocumentViewReport", b =>
                {
                    b.HasOne("API.Studying.Domain.Entities.Card", null)
                        .WithMany("CardViewReports")
                        .HasForeignKey("CardId")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.HasOne("API.Studying.Domain.Entities.Student", null)
                        .WithMany("CardViewReports")
            ...
            modelBuilder.Entity("API.Studying.Domain.Entities.Exercise", b =>
                {
                    ...
                    b.Navigation("ExerciseViewReports");
                });
            ...
            modelBuilder.Entity("API.Studying.Domain.Entities.Student", b =>
                {
                    ...
                    b.Navigation("ExerciseUserReports");
